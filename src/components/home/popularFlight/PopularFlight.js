...
const totalItems = 19; // Total number of items
...
const navigate=useNavigate()
  ...
  return (
    <Container>
      <Box sx={{ mt: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', mt: '40px' }}>
      ...
      <Carousel animation='slide' autoPlay={false} duration={600}>
