...
const FlightDetails = () => {
    ...
    const [selectedValue, setSelectedValue] = useState(`Adults: ${adults}, Children: ${children}, Infants: ${infants}`); // Initial count of children

    const itemData = [{ flight: "lhr", time: '22:30', date: '2034/34/45', airport: "LOndon air ways", terminal: '3', dep: 'los', deptime: '22;45', depDate: '34/45/6' },

    {
        flight: 'kri', time: '67;jc'
    }
    ]
    ...
    const hanldefinish = (data) => {
        const payload={...data,adults:adults,children:children,infants:infants}
        console.log(payload)
        // console.log(selectedValue, 'dataform')
    }
    return (
        <Box>
            <Container>
                ...
                <Box sx={{ border: '1px solid rgba(112, 112, 112, .15)', mt: '30px', paddingBottom: '30px', mb: "30px" }}>
                    ...
                    <Grid container spacing={10} >
                        ...
                        <Grid item lg={6}>
                            ...
                            <Form style={{ marginLeft: '20px' }} onFinish={hanldefinish}>
                                <Form.Item name='trip'>
                                    <Radio.Group>
                                ...
                                <Button htmlType='submit' style={{ background: '#5d1049', height: '50px', width: '100%', color: 'white', marginBottom: '20px' }}>Send Message</Button>
                            </Form>
